...
/**
 * This task fetches blocks from a chest and then the PlaceBlocksInChest can be added as a subsequent task to move these
 * blocks to a building which requires them.
 */
