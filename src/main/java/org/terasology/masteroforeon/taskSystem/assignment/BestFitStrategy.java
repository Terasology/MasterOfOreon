...
import org.terasology.masteroforeon.taskSystem.OreonAttributes;
...
public class BestFitStrategy implements AssignmentStrategy {
    ...
    private int calculateTaskSuitability(OreonAttributes target, OreonAttributeComponent attributes) {
        // The suitability rating is the arithmetic mean of the difference between the current value and the target 
        // value
