...
import org.terasology.masteroforeon.taskSystem.events.CloseTaskSelectionScreenEvent;
import org.terasology.masteroforeon.taskSystem.events.OpenTaskSelectionScreenEvent;
import org.terasology.masteroforeon.taskSystem.events.SetTaskTypeEvent;
...
public class TaskManagementClientSystem extends BaseComponentSystem {
    ...
    public void openTaskSelectionScreen(OpenTaskSelectionScreenEvent event, EntityRef player) {
        ...
        newBlockSelectionComponent.texture = Assets.get(TextureUtil.getTextureUriForColor(Color.BLUE.alterAlpha(100))
                , Texture.class).get();
    ...
    /**
     * Receives the {@link SetTaskTypeEvent} sent by the
     * {@link org.terasology.masteroforeon.taskSystem.nui.TaskSelectionScreenLayer}
    ...
    public void receiveSetTaskTypeEvent(SetTaskTypeEvent event, EntityRef player) {
        ...
        taskManagementSystem.setTaskType(newTaskType, event.getBuildingType(), event.getPlantType(), this.taskRegion,
                player);
