...
package org.terasology.masteroforeon.healthSystem;
...
import org.terasology.masteroforeon.deathSystem.DeathSystem;
        ...
        switch (cause) {
            case Hunger:
                ...
                DisplayNameComponent displayNameComponent =
                        notificationMessageEntity.getComponent(DisplayNameComponent.class);
