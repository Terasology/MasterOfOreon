...
//        }
    ...
    public void placeFenceAroundRegion(BlockRegion region) {
        ...
        BlockRegion leftRegion = new BlockRegion(new Vector3i(minX - 2, Y, minZ - 2), new Vector3i(minX - 2, Y, maxZ + 2));
        BlockRegion rightRegion = new BlockRegion(new Vector3i(maxX + 2, Y, minZ - 2), new Vector3i(maxX + 2, Y, maxZ + 2));
        BlockRegion topRegion = new BlockRegion(new Vector3i(minX - 1, Y, maxZ + 2), new Vector3i(maxX, Y, maxZ + 2));
        BlockRegion bottomRegion = new BlockRegion(new Vector3i(minX - 1, Y, minZ - 2), new Vector3i(maxX + 1, Y, minZ - 2));
