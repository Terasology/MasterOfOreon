...
/**
 * The component which is attached to the player and consits of info related to the happenings in the village. All changes made to this task
...
public class HoldingComponent implements Component<HoldingComponent> {
    ...
    public void copyFrom(HoldingComponent other) {
        ...
        this.lastBuildingInteractedWith = other.lastBuildingInteractedWith;
    }
}
